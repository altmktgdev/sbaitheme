<div class="main-menu">
	<ul class="main-menu__ul ">
		...
		<li class="main-menu__li"><a class="main-menu__anchor" href="https://www.google.com/" style="background-image: url('<?php echo get_theme_file_uri('images/mb-menu-ico.svg');?>');">Sports</a>
			<div class="main-menu__sub-menu-first-level">
				<span class="main-menu__mb-back"><img src="<?php echo get_theme_file_uri('images/mb-menu-back.svg');?>"></span>
				<ul class="push-menu"> 
					<li class="push-menu__li">
						<a class="push-menu__anchor" href="#">
							football
							<img class="push-menu__anchor-dk-ico" src="<?php echo get_theme_file_uri('images/sport-ico-white.svg');?>">
							<img class="push-menu__anchor-mb-ico" src="<?php echo get_theme_file_uri('images/sport-ico-blue.svg');?>"></a>
					...
					<li class="push-menu__li">
						<a class="push-menu__anchor" href="#">basketball
							<img class="push-menu__anchor-dk-ico" src="<?php echo get_theme_file_uri('images/sport-ico-white.svg');?>">
							<img class="push-menu__anchor-mb-ico" src="<?php echo get_theme_file_uri('images/sport-ico-blue.svg');?>">
						</a>
						<div class="push-menu__sub-menu-container">
							<span class="main-menu__mb-back-push">
								<img src="<?php echo get_theme_file_uri('images/mb-menu-back.svg');?>">
							</span>
							<ul class="push-menu__sub-menu-ul">
					...
					<li class="push-menu__li">
						<a class="push-menu__anchor" href="#">Baseball
							<img class="push-menu__anchor-dk-ico" src="<?php echo get_theme_file_uri('images/sport-ico-white.svg');?>">
							<img class="push-menu__anchor-mb-ico" src="<?php echo get_theme_file_uri('images/sport-ico-blue.svg');?>">
						</a>
						<div class="push-menu__sub-menu-container">
					...
					<li class="push-menu__li">
						<a class="push-menu__anchor" href="#">Hockey
							<img class="push-menu__anchor-dk-ico" src="<?php echo get_theme_file_uri('images/sport-ico-white.svg');?>">
							<img class="push-menu__anchor-mb-ico" src="<?php echo get_theme_file_uri('images/sport-ico-blue.svg');?>">
						</a>
						<div class="push-menu__sub-menu-container">
					...
					<li class="push-menu__li">
						<a class="push-menu__anchor" href="#">soccer
							<img class="push-menu__anchor-dk-ico" src="<?php echo get_theme_file_uri('images/sport-ico-white.svg');?>">
							<img class="push-menu__anchor-mb-ico" src="<?php echo get_theme_file_uri('images/sport-ico-blue.svg');?>">
						</a>
						<div class="push-menu__sub-menu-container">
					...
					<li class="push-menu__li">
						<a class="push-menu__anchor" href="#">Fighting
							<img class="push-menu__anchor-dk-ico" src="<?php echo get_theme_file_uri('images/sport-ico-white.svg');?>">
							<img class="push-menu__anchor-mb-ico" src="<?php echo get_theme_file_uri('images/sport-ico-blue.svg');?>">
						</a>
						<div class="push-menu__sub-menu-container">
					...
					<li class="push-menu__li">
						<a class="push-menu__anchor" href="#">motor sport
							<img class="push-menu__anchor-dk-ico" src="<?php echo get_theme_file_uri('images/sport-ico-white.svg');?>">
							<img class="push-menu__anchor-mb-ico" src="<?php echo get_theme_file_uri('images/sport-ico-blue.svg');?>">
						</a>
						<div class="push-menu__sub-menu-container">
					...
					<li class="push-menu__li">
						<a class="push-menu__anchor" href="#">tennis
							<img class="push-menu__anchor-dk-ico" src="<?php echo get_theme_file_uri('images/sport-ico-white.svg');?>">
							<img class="push-menu__anchor-mb-ico" src="<?php echo get_theme_file_uri('images/sport-ico-blue.svg');?>">
						</a>
						<div class="push-menu__sub-menu-container">
					...
					<li class="push-menu__li">
						<a class="push-menu__anchor" href="#">golf
							<img class="push-menu__anchor-dk-ico" src="<?php echo get_theme_file_uri('images/sport-ico-white.svg');?>">
							<img class="push-menu__anchor-mb-ico" src="<?php echo get_theme_file_uri('images/sport-ico-blue.svg');?>">
						</a>
						<div class="push-menu__sub-menu-container">
					...
					<li class="push-menu__li">
						<a class="push-menu__anchor" href="#">horse racing
							<img class="push-menu__anchor-dk-ico" src="<?php echo get_theme_file_uri('images/sport-ico-white.svg');?>">
							<img class="push-menu__anchor-mb-ico" src="<?php echo get_theme_file_uri('images/sport-ico-blue.svg');?>">
						</a>
						<div class="push-menu__sub-menu-container">
					...
					<li class="push-menu__li">
						<a class="push-menu__anchor" href="#">olympics games
							<img class="push-menu__anchor-dk-ico" src="<?php echo get_theme_file_uri('images/sport-ico-white.svg');?>">
							<img class="push-menu__anchor-mb-ico" src="<?php echo get_theme_file_uri('images/sport-ico-blue.svg');?>">
						</a>
						<div class="push-menu__sub-menu-container">
					...
					<li class="push-menu__li">
						<a class="push-menu__anchor" href="#">cycling
							<img class="push-menu__anchor-dk-ico" src="<?php echo get_theme_file_uri('images/sport-ico-white.svg');?>">
							<img class="push-menu__anchor-mb-ico" src="<?php echo get_theme_file_uri('images/sport-ico-blue.svg');?>">
						</a>
						<div class="push-menu__sub-menu-container">
					...
					<li class="push-menu__li">
						<a class="push-menu__anchor" href="#">esports
							<img class="push-menu__anchor-dk-ico" src="<?php echo get_theme_file_uri('images/sport-ico-white.svg');?>">
							<img class="push-menu__anchor-mb-ico" src="<?php echo get_theme_file_uri('images/sport-ico-blue.svg');?>">
						</a>
						<div class="push-menu__sub-menu-container">
